...
export const L2N7002SLLT1G = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      pinLabels={pinLabels}
      pinAttributes={{
  ...
  "jlcpcb": [
    "C22446827"
      ...
      manufacturerPartNumber="L2N7002SLLT1G"
      footprint={<footprint>
...
<courtyardoutline outline={[{"x":-1.8756000000000768,"y":1.774000000000001},{"x":2.0026000000000295,"y":1.774000000000001},{"x":2.0026000000000295,"y":-1.774000000000001},{"x":-1.8756000000000768,"y":-1.774000000000001},{"x":-1.8756000000000768,"y":1.774000000000001}]} />
      ...
      cadModel={{
        objUrl: "https://modelcdn.tscircuit.com/easyeda_models/assets/C22446827.obj?uuid=cefd4596db214da394d9632b2b88f8f2",
        stepUrl: "https://modelcdn.tscircuit.com/easyeda_models/assets/C22446827.step?uuid=cefd4596db214da394d9632b2b88f8f2",
